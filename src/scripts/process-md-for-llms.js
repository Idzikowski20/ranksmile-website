...
/**
 * Files whose public/md output is generated by another script.
...
function buildPageHeader(slug, navMap, _relativePath) {
  ...
  // Index line (always)
  lines.push(`> Full Ranksmile documentation index: ${BASE_URL}/docs/llms.txt`);
...
function stripNavigationContext(content) {
  let stripped = content.replace(
    /^(?:> This page location:[^\n]*\n)?> Full (?:Ranksmile|Neon) documentation index:[^\n]*\n(?:> IMPORTANT: If this page[^\n]*\n)?\n/,
    ''
  );
